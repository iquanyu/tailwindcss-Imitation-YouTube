<template>
  <!-- <img alt="Vue logo"
  src="./assets/logo.png" />-->
  <header class="bg-white divide-y border-b border-gray-200">
    <!--ml-18-->
    <div class="flex items-center justify-between mx-4 h-14">
      <!--logo-->
      ...
      <div class="flex items-center justify-center flex-grow">
        <input type="text"
               placeholder="搜索"
               class="border border-gray-400 h-8 px-1 py-2 focus:outline-none focus:border-blue-600 rounded-none w-2/5 "
               name="search" />
        <button class="bg-gray-100 flex items-center justify-center border border-gray-400 border-l-0 h-8 w-16 hover:bg-gray-200">
          <svg xmlns="http://www.w3.org/2000/svg"
               class="h-6 w-6"
               fill="none"
               viewBox="0 0 24 24"
      ...
      <div class="flex items-center justify-center space-x-6">
        ...
        <button class="w-8 h-8 bg-blue-300 rounded-full"></button>
      </div>
    </div>
  </header>
  <div class="flex">
